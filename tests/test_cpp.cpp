...
int main(void)
{
  ...
  try
  {
    ...
    test(56, Math::simpGrowth(5, 0.05, 3) == 5.75);
    test(57, Math::simpGrowth(140, 0.1, 4) == 196);
    test(58, Math::roundTo(Math::simpGrowthRate(5, 5.5, 4), 6) == 0.025);
    test(59, Math::roundTo(Math::simpGrowthRate(145, 153, 3), 6) == 0.018391);
    test(60, Math::roundTo(Math::compGrowth(5, 0.2, 3), 6) == 8.64);
    test(61, Math::roundTo(Math::compGrowth(2500, 0.17, 13), 6) == 19246.697092);
    test(62, Math::roundTo(Math::compGrowthRate(5, 8.64, 3), 6) == 0.2);
    test(63, Math::roundTo(Math::compGrowthRate(5200, 7640.50, 5), 6) == 0.08);
